...
export default function TodoFilter({ filterOptions, categories, onFilterChange }: TodoFilterProps) {
  ...
  return (
    <div className="bg-surface rounded-lg shadow border border-border p-4 mb-6">
      <h2 className="text-lg font-semibold mb-4 text-text">Filter & Urutkan</h2>
      ...
      {/* Sort Options */}
      <div className="mt-4">
        <label htmlFor="sort" className="block text-sm font-medium text-text mb-1">
          Urutkan berdasarkan
        </label>
        <select
          id="sort"
      ...
      {(filterOptions.search ||
        ...
        <button
          ...
          className="mt-4 px-4 py-2 text-sm text-primary hover:bg-primary hover:bg-opacity-10 rounded transition"
        >
          Reset Filter
        </button>
      )}
